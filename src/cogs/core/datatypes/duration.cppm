...
export module reactaio.internal.duration;
...
export namespace reactaio::internal {
	...
	struct duration {
		 ...
		 */
		[[nodiscard]] constexpr std::string to_string(bool shortened = false) const {
			std::string res;
		 ...
		 */
		[[nodiscard]] constexpr std::time_t since_epoch() const {
		 ...
		 */
		constexpr duration& operator=(const duration& dur) = default;
	};
