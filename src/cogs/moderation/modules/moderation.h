...
namespace reactaio::moderation {
	...
	/**
	 * @brief view_warnings - View all warnings for a member of the server.
	...
	/**
	 * @brief view_warnings_list - View all warnings for the server members as a paginated messsage.
	 * @param command The wrapper struct containing all the information for the action. ie. guild, reason for kick, server settings etc.
	 */
