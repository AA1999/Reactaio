...
class softban_wrapper: public hybrid_wrapper {
	...
	/**
	 * @brief check_permissions - Checks if the softban operation(s) can be performed (bot perms, author being owner etc)
	 */
	void check_permissions() override;

	/**
	 * @brief process_softbans - Starts the softban operation on all the given users/members.
	 */
